...
- Toasts/global banners should not push sticky navigation down, overlap header or bottom navigation, create page jump, or add scrollbars to header/bottom navigation.
...
- Feedback toasts are dismissible through a visible control, disappear automatically for non-critical success messages, and do not obscure primary actions for long-running workflows.
